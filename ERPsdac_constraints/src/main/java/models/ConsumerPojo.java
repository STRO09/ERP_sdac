...
public class ConsumerPojo {
	...
	public void LoginConsumer(ConsumerPojo consumerPojo) {
		// TODO Auto-generated method stub
		new ConsumerImplementor().LoginConsumer(consumerPojo);
	}
